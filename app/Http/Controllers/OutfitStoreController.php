...
class OutfitStoreController extends Controller
{
    public function showList()
    {
        ...
        $data = Http::acceptJson()
            ->get('http://localhost/books-store/public/api/outfits')
            ->json();
    ...
    {
        $data = Http::acceptJson()
            ->get('http://localhost/books-store/public/api/outfit/show' . $id . '?one')
            ->json();
