                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-2 form-group">
                                ...
                                <select name="currency" class="form-control">
                                    ...
                                    <option value="{{$name}}" @if(session()->get('currency', '') == $name) selected @endif
                                        >{{$name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{route('fixer_form')}}" class="btn btn-primary mt-2"> New calculation</a>
                            </div>
                            <div class="col-12">
