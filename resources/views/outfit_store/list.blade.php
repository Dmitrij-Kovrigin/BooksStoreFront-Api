        ...
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="book__title">
                            <a href="{{route('outfits_store_show_outfit', $outfit->id)}}"> {{$outfit->type}}</a>
                        </div>
                        <div class="book__image">
                            <div class="book__image__img">

                                <img src="{{$outfit->photo ?? asset('img/noimage.png')}}">
                            </div>
                        </div>
                ...
                <div class="book__info">
                    ...
                    <div style="color:brown;">Discount: {{$outfit->discount}}</div><br>
                    <div>Brand name: {{$outfit->brand}}</div>
                </div>
